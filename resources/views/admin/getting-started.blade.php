<div class="box box-success" id="getting-started">
    ...
    <div class="box-body">
        ...
        @php $links = ['add_products' => 'setup', 'first_sale' => 'sale-records/create', 'invite_staff' => 'employees', 'set_up_momo' => 'engagement', 'whatsapp_receipts' => 'engagement']; @endphp
        <ul class="list-unstyled" style="margin:0">
            @foreach($checklist['items'] as $item)
                <li style="padding:4px 0">
                    ...
                    @else <a href="{{ admin_url($links[$item['key']] ?? 'setup') }}">{{ $item['label'] }}</a> @endif
                </li>
            @endforeach
        </ul>
    </div>
