...
class BudgetItemPolicy
{
    ...
    {
        return $user->company_id === $budgetItem->company_id;
    }
     ...
     */
    public function restore(User $user, BudgetItem $budgetItem): bool
    {
        return $user->company_id === $budgetItem->company_id;
    }
     ...
     */
    public function forceDelete(User $user, BudgetItem $budgetItem): bool
    {
        return $user->company_id === $budgetItem->company_id;
    }
}
