...
return [
    ...
    */
    'route' => [
        ...
        'middleware' => ['web', \App\Http\Middleware\PlatformAdminOnly::class, 'admin', \App\Http\Middleware\RedirectToNewUi::class, \App\Http\Middleware\EnsureWebAccess::class, \App\Http\Middleware\AdminPermission::class],
    ],
